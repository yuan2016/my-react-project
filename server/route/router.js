...
//测试
let test = require('../controller/test/test')
//登录验证
...
router.use(function (req, resp, next) {
  if (req.method === 'POST') {
    if (req.url === '/api/test' || req.url === '/api/login' || req.url === '/api/getLoginInfo' || req.url === '/api/getVerificationCode' || req.url === '/api/getPicCode' || req.url === '/api/loginEmail' || req.url === '/api/getInfoEmail' || req.url === '/api/modifyInfo') {
      next()
    } else {
...
/*测试*/
router.post(api.test, test.fetchAll)
/*登录验证*/
